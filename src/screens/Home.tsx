      ...
      <View style={styles.contentWrapper}>
        ...
        <View style={styles.buttons}>
          <CustomButton
            style={styles.button}
            title={'Create new'}
            onPress={() => props.navigation.navigate('CreateForm')}
          />
          <CustomButton
            style={styles.button}
            title={'Play'}
            ...
            onPress={() =>
              props.navigation.navigate('BingoGrid', {grids: grids})
            }
          />
          <CustomButton
            style={styles.button}
            title={'My grids'}
            onPress={() => {
              props.navigation.navigate('MyGrids', {grids: grids});
            }}
          />
          <CustomButton
            style={styles.button}
            title={'Import grid'}
            onPress={() => {
              props.navigation.navigate('ImportGrid');
            }}
          />
